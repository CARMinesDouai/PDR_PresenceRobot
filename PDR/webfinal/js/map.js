var Map = function (a) {
	...
	//----------------------------------------------//
	// Initialisation des métas données de la carte //
	//----------------------------------------------//
	...
	//----------------------------------------------------//
	// Zoom sur la carte (non utilisé sur cette révision) //
	//----------------------------------------------------//
	...
	this.viewer.scene.canvas.onmouseup = this.showTrajectory;

	//-------------------------------------//
	// Afficage du tracé de la trajectoire //
	//-------------------------------------//	
	...
	//----------------------------------//
	// Lance l'intialisation de l'objet //
	//----------------------------------//
	this.init();
}